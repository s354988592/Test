...
export default class BarChartH extends Component {
    ...
    makeEchartOption = (data)=>{
        let barChart  = echarts.init(this.refs.contChart)
         //从父组件获得data值
    ...
    render() {      
        return (
            <div id="contChart" ref="contChart" style={{width:"100%",height:"22.5rem"}}></div>
        )
    }
};